        ...
        case 'cross_error':
          return (
            <svg viewBox="0 0 51 51">
              <circle fill="#F16767" cx="25.5" cy="25.5" r="25.5"/>
              <path fill="#FFFFFF" d="M27.5,26.8l7.1-7.1c0.4-0.4,0.4-1,0-1.4s-1-0.4-1.4,0l-7.1,7.1L19,18.2c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4
        ...
        case 'plus':
          return (
            <svg viewBox="0 0 18 18">
              <path fill="#545A6A" d="M9.3,18.5c-0.6,0-1-0.4-1-1v-7.3H1c-0.6,0-1-0.4-1-1s0.4-1,1-1h7.3V1c0-0.6,0.4-1,1-1s1,0.4,1,1v7.3h7.3
                c0.6,0,1,0.4,1,1s-0.4,1-1,1h-7.3v7.3C10.3,18.1,9.8,18.5,9.3,18.5z"/>
            </svg>
          )
      } 
    }
